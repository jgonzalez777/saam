...
<html>
    <head>
        ...
        <script>
            $(document).ready(function(){
                ...
                $("#actualizarTipoCultivoBtn").on("click", function(){
                    $(".error").hide();
                    var validacion = true;
                    validacion = validar();
                    if(validacion)
                        $("#actualizarTipoCultivo").submit();
                });
    ...
    <body>
        ...
        <article>
            <center><h3 id="titulo">Actualizar Tipo de Cultivo</h3></center>
            <s:form id="actualizarTipoCultivo" action="actualizarTipoCultivo"  method="POST" namespace="/">
                <s:hidden id="tipoCultivoId" key="tipoCultivo.id"/>
                <table>
                    <tr>    
                    ...
                    <tr>
                        <td colspan="2" >
                            <center>
                                <button type="button" class="btn btn-success" id="actualizarTipoCultivoBtn">Actualizar Tipo Cultivo</button>
